...
def get_logits(new_input, length, quant, first=[]):
    """
    ...
    # here we obtain two more outputs other than the final logits
    # hiddenstates is the (forward, backward) bidirectional states calculated over time 
    # biRnn_inputs is the layer before feeding to the bidirectional rnn
    logits, hiddenstates, biRnn_inputs, caps = DeepSpeech.BiRNN(features, length, [0]*10, quant)
    
    return logits, hiddenstates, biRnn_inputs, caps
